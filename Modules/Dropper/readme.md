...
Parade : Surveiller et restreindre les processus système (comme Python) qui tentent de se connecter à des adresses IP externes inconnues.
...
Impact : Les équipes informatiques qui inspectent le serveur ne verront qu'un processus système légitime, rendant l'investigation très complexe.
Parade : Déployer un outil de sécurité (EDR/Auditd) configuré pour alerter sur l'utilisation anormale de la fonction memfd_create.

3. net_bin_dropper.py
...
Parade : Bloquer les exécutions de programmes provenant de répertoires virtuels atypiques comme /proc/self/fd/.
